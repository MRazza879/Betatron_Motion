...
This repository contains two main codes developed in C and other python scripts to extract plots and further analysis. I start describing the 2D map and then the 4D map. 
...
```
For example to run the code you may use:
```bash
...
- '**N_steps**': The number of steps to explore the lattice of initial conditions built in the code (suggested value: 200 to obtain my results).  
